...
public class QuartzMultipleConnectorsDifferentConfigTestCase extends FunctionalTestCase
{
    ...
    public void twoConnectorsWithDifferentNamesCreatesSchedulersWithDifferentNames() throws Exception
    {
        ...
        assertThat("scheduler-" + QUARTZ_CONNECTOR_NAME_1, equalTo(quartzConnector1.getQuartzScheduler().getSchedulerName()));
        assertThat("scheduler-" + QUARTZ_CONNECTOR_NAME_2, equalTo(quartzConnector2.getQuartzScheduler().getSchedulerName()));
    }
