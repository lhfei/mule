...
public class WildcardSpecificCasesTestCase extends FunctionalTestCase
{
    ...
    {
        final String url = String.format(URL, listenPort.getNumber(), "prefix/keyword/suffix");
    ...
    {
        final String url = String.format(URL, listenPort.getNumber(), "a/b");
        final Response httpResponse = Request.Get(url).execute();
    ...
    {
        final String url = String.format(URL, listenPort.getNumber(), "a/b/c/d/e/f");
        final Response httpResponse = Request.Get(url).execute();
